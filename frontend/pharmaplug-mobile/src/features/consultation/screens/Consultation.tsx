    ...
    return ( 
        <MainContainer title="Consultation">
            ...
            <Container>
                ...
                <View>
                    {data.map((value, idx)=>(
                        <TouchableOpacity key={idx} style={{marginBottom: 10}} onPress={()=>navigateToDoctorList(value.id)}>
                            <ImageBackground source={{uri: value.image}} style={styles.imageContainer}>
                                <AltAppText style={{fontSize: 18}}>
                                    {value.name}
                                </AltAppText>
                            </ImageBackground>
                        </TouchableOpacity>
