  ...
  return (
    <MainContainer title="Drug Details" back>
      <Container>
        ...
        <AppText style={styles.headerText}>{data.name}</AppText>
        <AppText style={styles.priceText}>NGN {data.price}</AppText>
        <AppText style={{ marginBottom: 5 }}>Description</AppText>
        <AppText style={{ lineHeight: 19, fontSize: 14, fontWeight: 400 }}>
          {data.description}
        </AppText>
        {altDrugs.length > 0 && (
          <>
            <AppText>Related Drugs</AppText>
