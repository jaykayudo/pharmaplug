            ...
            <Container>
                <View>
                    <View style={styles.tabButtonCover}>
                        <TouchableOpacity style={[styles.tabButtons, activePage === 1? styles.activeTabButton:{}]} onPress={()=>setActivePage(1)}>
                            <AppText>Profile</AppText>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.tabButtons, activePage === 2? styles.activeTabButton:{}]} onPress={()=>setActivePage(2)}>
                    ...
                    <View>
                        {activePage === 1 && (
                            <View style={{marginVertical: 20}}>
                                ...
                                <View style={{marginBottom: 30}}>
                                    ...
                                    <AppText style={styles.smallText}>This image will be displayed on your profile</AppText>
                                </View>
                                <View style={{marginBottom: 10}}>
                                    <AppText style={styles.headerText}>Personal Information</AppText>
                                    <AppText style={styles.smallText}>This image will be displayed on your profile</AppText>
                                </View>
                                <View>
                                    <View style={styles.formGroup}>
                                        <NormalInput label= "First Name"  value={firstName} onChangeText={setFirstName}/>
                                    </View>
                                    <View style={styles.formGroup}>
                                        <NormalInput label="Last Name" value={lastName} onChangeText={setLastName} />
                                    </View>
                                    <View style={styles.formGroup}>
                                        <NormalInput label="Email" value={email} editable={false}/>
                                    </View>
                                    <View style={styles.formGroup}>
                                        <NormalInput label="Username" value={username} onChangeText={setUsername} />
                                    </View>
                                    <View style={styles.formGroup}>
                        ...
                        {activePage === 2 && (
                            <View style={{marginVertical: 20}}>  
                                ...
                                <View style={styles.formGroup}>
                                    <NormalInput label="Current Password" secureTextEntry value={oldPassword} onChangeText={setOldPassword} />
                                </View>
                                <View style={styles.formGroup}>
                                    <NormalInput label="New Password" secureTextEntry value={newPassword} onChangeText={setNewPassword}/>
                                </View>
                                <View style={styles.formGroup}>
                                    <NormalInput label="Confirm New Password"  secureTextEntry value={confirmNewPassword} onChangeText={setConfirmNewPassword}/>
                                </View>
                                <View>
