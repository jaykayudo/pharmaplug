    ...
    <>
      {loading ? (
        ...
        <div className="container">
          <h2 className="mb-2em">
            Consultation with {data.user?.first_name} {data.user?.last_name}
          </h2>
          ...
          <div className="flex align-center" style={{ padding: '30px 0' }}>
            ...
            <span className="cost-box"># {data.cost}</span>
          </div>
          ...
          <Modal
            ...
            open={isModalOpen}
            onOk={modalParams.action}
            okText={modalParams.btnTitle}
            onCancel={handleCancel}
          >
            {modalState === 1 && (
              <div>
                <h3 style={{ marginBottom: 15 }}>
                  Enter the location for the consultation (virtual meet link or
                  physical address)
                </h3>
                <NormalInput
                  label={'Details'}
            ...
            {modalState === 2 && (
              <div>
                <h3 style={{ marginBottom: 15 }}>
                  Choose a new date and time and the location for the
                  consultation (virtual meet link or physical address)
                </h3>
                <NormalInput
                  label={'Date'}
                  type="date"
                ...
                >
                  Note: The duration will be the same as the patient's initial
