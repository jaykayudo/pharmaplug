export const validateName = (text, field_name = '', is_full_name = false) => {
  let errorText = ''
  let status = true
  if (text.length < 3) {
    status = false
...
export const validateEmail = (text, field_name = 'email') => {
  let errorText = ''
  let status = true
  let re =
    /^(([^<>()[\]\.,;:\s@\"]+(\.[^<>()[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i
...
export const validatePhoneNumber = (text, field_name = 'Phone number') => {
  let errorText = ''
  let status = true
  if (text.length !== 11) {
    status = false
...
export const validatePassword = (text, field_name = '') => {
  let errorText = ''
  let status = true
  if (text.length < 8) {
    status = false
